...
import com.ss.oauth2.converters.ClientDetailsConverter;
import com.ss.oauth2.converters.UserDetailsConverter;
...
public class ControlledCacheService {
    ...
    @Cacheable(cacheNames = "cache_client", key = "T(com.ss.oauth2.services.ControlledCacheService).#clientId")
    ...
    @Cacheable(cacheNames = "cache_user", key = "T(com.ss.oauth2.services.ControlledCacheService).#username")
